...
// BB5.S41: c[0x0][0x164] -> param_0[1]
// BB5.S61: c[0x0][0x160] -> param_0[0]
// BB5.S62: c[0x0][0x164] -> param_0[1]
// BB5.S76: c[0x0][0x160] -> param_0[0]
// BB5.S77: c[0x0][0x164] -> param_0[1]
// BB5.S92: c[0x0][0x160] -> param_0[0]
// BB5.S94: c[0x0][0x164] -> param_0[1]
      ...
      if (v154 >= 1) {
        ...
        if (v155 >= 3) {
          BB9 {
            ...
            v21 = v156 - arg4_word0;
            v158 = RZ;
            arg2_ptr_lo32 = arg2_ptr.lo32;
            arg2_ptr_hi32 = arg2_ptr.hi32;
            v6 = v14 + 3;
            arg3_ptr_lo32 = arg3_ptr.lo32;
            arg3_ptr_hi32 = arg3_ptr.hi32;
            v13 = ((int32_t)v14) >> 31;
          }
          // Loop header BB10
          while (v21 != RZ) {
            BB10 {
              v162 = v6 - 3;
              b41 = v162 >= v157;
              b42 = carry_u32_add3(v14, arg2_ptr_lo32, RZ);
              v163 = v14 + arg2_ptr_lo32;
              v164 = v13 + arg2_ptr_hi32 + (b42 ? 1 : 0);
              ...
              v173 = shmem_u8[v171];
              b43 = v172 >= v157;
              b3 = carry_u32_add3(v14, arg3_ptr_lo32, RZ);
              v9 = v14 + arg3_ptr_lo32;
              shmem_u8[u12] = v173;
              shmem_u8[v171] = v166;
              v174 = shmem_u8[u12];
              v175 = v166 + v174;
              if (!b41) v176 = v175 & 255;
              v8 = v13 + arg3_ptr_hi32 + (b3 ? 1 : 0);
              ...
              v203 = v161 + v19;
              v21 = v21 + 4;
              b40 = carry_u32_add3(arg3_ptr_lo32, 4, URZ);
              arg3_ptr_lo32 = arg3_ptr_lo32 + 4;
              v158 = v158 + 4;
              b39 = carry_u32_add3(arg2_ptr_lo32, 4, URZ);
              arg2_ptr_lo32 = arg2_ptr_lo32 + 4;
              v204 = ((int32_t)v203) >> 31;
              arg3_ptr_hi32 = URZ + arg3_ptr_hi32 + (b40 ? 1 : 0);
              v6 = v6 + 4;
              arg2_ptr_hi32 = URZ + arg2_ptr_hi32 + (b39 ? 1 : 0);
