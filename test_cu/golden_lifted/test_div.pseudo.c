BB0 {
  ...
  R0.3 = R5.0 * R0.2 + R4.1;
  P2.0 = R5.0 > R0.3;
  R0.4 = !P2.0 ? (R0.3 - R5.0) : R0.3;
  R3.3 = !P2.0 ? (R3.2 + 1) : R3.2;
  P2.1 = 0 != ConstMem(0, 356);
  P0.0 = R0.4 >= R5.0;
  R3.4 = P0.0 ? (R3.3 + 1) : R3.3;
  R5.1 = R3.4;
  R3.5 = ConstMem(0, 364);
  R5.2 = !P1.0 ? (-R5.1 + 0 + 0) : R5.1;
  R5.3 = !P2.1 ? (~ConstMem(0, 356)) : R5.2;
