      ...
      if (R2.9 >= 3) {
        ...
        while (R10.15 != RZ) {
          BB10 {
            ...
            R11.20 = R19.3 + R12.29;
            R10.15 = R10.14 + 4;
            UP0.2 = carry_u32_add3(UR8.2, 4, URZ);
            UR8.3 = UR8.2 + 4;
            R9.17 = R9.16 + 4;
            UP1.2 = carry_u32_add3(UR10.2, 4, URZ);
            UR10.3 = UR10.2 + 4;
            R14.42 = ((int32_t)R11.20) >> 31;
            UR9.3 = URZ + UR9.2 + (UP0.2 ? 1 : 0);
            R8.19 = R8.18 + 4;
            UR11.3 = URZ + UR11.2 + (UP1.2 ? 1 : 0);
      ...
      if (P0.3) {
        ...
        while (R6.12 != RZ) {
          BB13 {
            ...
            UR4.12 = UR4.11 + 1;
            R6.12 = R6.11 - 1;
            P2.30 = carry_u32_add3(R9.20, 1, RZ);
            R9.21 = R9.20 + 1;
            ...
            P1.20 = carry_u32_add3(R12.32, 1, RZ);
            R12.33 = R12.32 + 1;
            R3.19 = R4.19 + R3.18;
