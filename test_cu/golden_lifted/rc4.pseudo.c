    ...
    if (P0) {
          ...
          if (P1) {
            ...
            while (P1) {
              BB10 {
                ...
                P2.19 = R2.11 >= R7.11;
                R2.12 = R17.6 + UR10.2;
                R3.10 = R18.5 + UR11.1 + (P1.11 ? 1 : 0);
                if (P2.19) R14.38 = *R2.12@64;
                UR4.2 = UR4.1 + 1;
                UR5.2 = UR4.2 >> 31;
                ...
                R5.19 = R18.5 + UR9.1 + (P3.9 ? 1 : 0);
                if (P2.19) R13.22 = shmem_u8[R13.21];
                UR4.4 = UR4.3 + 1;
                UR5.5 = UR4.4 >> 31;
                UR5.6 = hi32(UR5.5 + (UR4.4 << 8));
                UR5.7 = UR5.6 & 4294967040;
                if (P2.19) R15.11 = R14.38 ^ R13.22;
                if (P2.19) *R4.16@64 = R15.11;
                if (P1.12) R16.7 = *R2.12+1@64;
                UR4.5 = UR4.4 - UR5.0;
                ...
                P2.20 = R14.40 >= R7.11;
                if (P1.12) R13.28 = shmem_u8[R13.27];
                UR4.6 = UR4.5 + 1;
                UR5.8 = UR4.6 >> 31;
                ...
                if (P1.12) *R4.16+1@64 = R15.12;
                if (P2.20) R16.8 = *R2.12+2@64;
                R12.27 = R20.2 + R11.19;
                P1.13 = R8.18 >= R7.11;
                R13.29 = R12.27 >> 31;
                ...
                if (P2.20) R13.34 = shmem_u8[R13.33];
                UR4.8 = UR4.7 + 1;
                UR5.11 = UR4.8 >> 31;
                ...
                if (P2.20) *R4.16+2@64 = R15.13;
                if (P1.13) R16.9 = *R2.12+3@64;
                R11.20 = R19.3 + R12.29;
                R10.15 = R10.14 + 4;
                UR8.3 = UR8.2 + 4;
                R9.17 = R9.16 + 4;
                UR10.3 = UR10.2 + 4;
                R14.42 = R11.20 >> 31;
                UR9.2 = URZ + UR9.1 + (UP0.0 ? 1 : 0);
                R8.19 = R8.18 + 4;
                UR11.2 = URZ + UR11.1 + (UP1.0 ? 1 : 0);
                ...
                if (P1.13) R3.14 = shmem_u8[R3.13];
                if (P1.13) R13.35 = R16.9 ^ R3.14;
                if (P1.13) *R4.16+3@64 = R13.35;
                P1.14 = R10.15 != RZ;
            ...
            if (P0) {
              BB12 {
                ...
                R2.15 = R0.1 >> 31;
                R13.37 = R2.15 + ConstMem(0, 380) + (P0.3 ? 1 : 0);
                R10.17 = R2.15 + ConstMem(0, 372) + (P1.15 ? 1 : 0);
              }
              // Loop header BB13
              while (P0) {
                BB13 {
      ...
      while (P1) {
        BB5 {
          ...
          R11.2 = hi32(R6.7 + (ConstMem(0, 356) << 1)) + (P2.2 ? 1 : 0);
          R10.3 = *R10.2@64;
          R3.3 = -R9.0;
          R12.4 = R2.6 + 1;
          R8.5 = RZ;
          ...
          R3.7 = R4.4;
          P2.3 = R3.7 > R8.6;
          if (P2.3) R8.7 = R8.6 - R4.0;
          P2.4 = R3.7 > R8.7;
          if (P2.4) R8.8 = R8.7 - R4.0;
          if (P3.2) R8.9 = -R8.0;
          R9.5 = !P1 ? R5.7 : R8.9;
          R8.10 = R9.5 + ConstMem(0, 352);
          R9.6 = hi32(R9.5 + (ConstMem(0, 356) << 1)) + (P2.4 ? 1 : 0);
          R9.7 = *R8.10@64;
          R11.3 = R2.6 + 2;
          R13.3 = IABS(R11.3);
          P3.3 = R11.3 >= RZ;
          ...
          P2.5 = R3.7 > R12.7;
          if (P2.5) R12.8 = R12.7 - R4.0;
          P2.6 = R3.7 > R12.8;
          if (P2.6) R12.9 = R12.8 - R4.0;
          if (P3.3) R12.10 = -R12.0;
          R8.11 = !P1 ? R5.7 : R12.10;
          R12.11 = R8.11 + ConstMem(0, 352);
          R13.4 = hi32(R8.11 + (ConstMem(0, 356) << 1)) + (P2.6 ? 1 : 0);
          R8.12 = *R12.11@64;
          R11.4 = R2.6 + 3;
          R15.2 = IABS(R11.4);
          P3.4 = R11.4 >= RZ;
          ...
          P2.7 = R3.7 > R14.4;
          if (P2.7) R14.5 = R14.4 - R4.0;
          P2.8 = R3.7 > R14.5;
          if (P2.8) R14.6 = R14.5 - R4.0;
          if (P3.4) R14.7 = -R14.0;
          R14.8 = !P1 ? R5.7 : R14.7;
          R12.12 = IADD3(R10.3, R7.2, R16.2);
          R10.4 = R14.8 + ConstMem(0, 352);
          R7.3 = R12.12 >> 31;
          R11.5 = hi32(R14.8 + (ConstMem(0, 356) << 1)) + (P2.8 ? 1 : 0);
          ...
          if (P2.13) R14.26 = R14.25 - R4.0;
          P3.7 = R12.17 >= RZ;
          P2.14 = R3.7 > R14.26;
          if (P2.14) R14.27 = R14.26 - R4.0;
          if (P3.7) R14.28 = -R14.0;
          R14.29 = !P1 ? R5.7 : R14.28;
          R10.7 = R14.29 + ConstMem(0, 352);
          R12.18 = IADD3(R7.4, R17.4, R18.3);
          R7.5 = R12.18 >> 31;
          R11.8 = hi32(R14.29 + (ConstMem(0, 356) << 1)) + (P2.14 ? 1 : 0);
          ...
          if (P2.15) R14.33 = R14.32 - R4.0;
          P3.8 = R12.19 >= RZ;
          P2.16 = R3.7 > R14.33;
          if (P2.16) R14.34 = R14.33 - R4.0;
          if (P3.8) R14.35 = -R14.0;
          R5.8 = !P1 ? R5.7 : R14.35;
          R4.5 = R5.8 + ConstMem(0, 352);
          R9.10 = IADD3(R9.9, R16.4, R15.7);
          R10.8 = R9.10 >> 31;
          R5.9 = hi32(R5.8 + (ConstMem(0, 356) << 1)) + (P1.7 ? 1 : 0);
